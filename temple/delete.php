        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="update.php">Festival update</a></li>
                 <li><a class="active" href="delete.php">Festival  delete</a></li>
...
<body>
    <h5 style="color: darkblue;">Festival deleted data</h5>
  <table style="background-color: yellowgreen;">
    ...
    <tbody>
      <!-- PHP code to fetch festival data from the database and display it in rows -->
      <?php
    ...
    die("Connection failed: " . $conn->connect_error);
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          ...
          // Add a delete button/link with the festival ID as a parameter
          echo "<td><a href='de.php?id=" . $row["FestivalID"] . "'>Delete</a></td>";
          echo "</tr>";
        }
      } else {
